...
def parse_detail(html,url):
    alllog.logger.info("江西省税务局: %s"%url)
    doc=pq(html)
    data={}
...
def main():
    url="http://jiangxi.chinatax.gov.cn/module/web/jpage/dataproxy.jsp?"
    for i in range(0,2):
        params={'startrecord':str(i*45+1), 'endrecord': str(i*45+45), 'perpage': '15'}
        data={'col': '1', 'webid': '26', 'path': 'http://jiangxi.chinatax.gov.cn/', 'columnid': '31884', 'sourceContentType': '1', 'unitid': '57364', 'webname': '国家税务总局江西省税务局', 'permissiontype': '0'}

...
def parse_detail(html,url):
    alllog.logger.info("武汉市人民政府: %s"%url)
    doc=pq(html)
    data={}
...
def main():
    for i in range(0,52):
        print(i)
        if i==0:
            url="http://www.wh.gov.cn/hbgovinfo/zwgk_8265/tzgg/index.html"
        else:
            url="http://www.wh.gov.cn/hbgovinfo/zwgk_8265/tzgg/index_"+str(i)+".html"
        html=get(url)
        parse_index(html)
